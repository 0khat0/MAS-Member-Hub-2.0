  ...
  return (
    <div className="min-h-screen w-full bg-gray-900 font-poppins overflow-x-hidden">
      <div className="max-w-4xl mx-auto space-y-6">
        ...
        {/* Family Members Section - Only show when there are actually family members (2+ members) */}
              ...
              {familyMembers.filter(m => !m.is_deleted).map((member) => (
                ...
                >
                  ...
                  <button
                    ...
                    className={`absolute top-1 right-1 w-5 h-5 rounded-full flex items-center justify-center transition-colors duration-200 ${
        ...
        <div className="bg-[#181c23] border border-gray-700 rounded-2xl shadow-xl p-8 mb-4">
          <div className="mb-6 flex items-center justify-between">
            ...
            {/* Settings Icon - Only show for individual profiles */}
            {familyMembers.length <= 1 && (
              <button
                type="button"
